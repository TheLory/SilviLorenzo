...
public class MoveVirtualRobot {
    ...
    protected String boundaryWalk() {
        String track = "";
        boolean collision=false;
        for(int lato=0;lato<4;lato++){
            do{
                collision=moveForward(300);
                track = track+"W";
            }while(!collision);
            moveLeft(300);
            track = track+"L";
    ...
    public static void main(String[] args) {
        ...
        System.out.println("moving robot along boundary walk");
        System.out.println(appl.boundaryWalk());
...
//        moveFailed = appl.moveForward(1000);
//        System.out.println("MoveVirtualRobot | moveForwared failed= "+ moveFailed);
